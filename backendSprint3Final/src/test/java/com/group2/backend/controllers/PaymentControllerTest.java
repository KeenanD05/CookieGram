...
// @Test
// void createPaymentIntent_ShouldReturnSuccess_WhenValidRequest() throws
// Exception {
...
// PaymentResponse response = new PaymentResponse("success", "Payment intent
// created");
...
// @Test
// void checkPaymentStatus_ShouldReturnStatus_WhenValidPaymentIntent() throws
// Exception {
// PaymentResponse response = new PaymentResponse("succeeded", "Payment
// succeeded");
// when(stripeService.checkPaymentStatus(TEST_PAYMENT_INTENT)).thenReturn(response);

// mockMvc.perform(get("/payments/check-payment-status/{paymentIntentId}",
// TEST_PAYMENT_INTENT))
// .andExpect(status().isOk())
...
// when(stripeService.confirmPayment(anyString(),
...
// @Test
// void confirmPayment_ShouldReturnBadRequest_WhenMissingPaymentIntentId()
// throws Exception {
// ConfirmPaymentRequest request = new ConfirmPaymentRequest();
// request.setPaymentMethodId(TEST_PAYMENT_METHOD);
