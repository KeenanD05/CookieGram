    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            if (cookieRepository.count() == 0) {
                ...
                chocolateChip.setName("Pack of 3 Classic Chocolate Chip Cookies");
                ...
                chocolateChip.setDescription("Get three classic chocolate chip cookies, loaded with rich chocolate chips at a great price!");
                chocolateChip.setBasePrice(6.99);
                ...
                sugarCookie.setName("Gift with love");
                sugarCookie.setType("Sugar");
                sugarCookie.setColor("White");
                sugarCookie.setMessage("Sweet Treats");
                sugarCookie.setIcing("Vanilla");
                sugarCookie.setDescription("Send a gift-wrapped box of our delightful cookies to your loved ones this season");
                sugarCookie.setBasePrice(15.49);
                ...
                oatmealRaisin.setName("Buy 1 Cookie and Get 1 Free");
                ...
                oatmealRaisin.setDescription("Buy 1 of our delicious cookies and get one free!");
